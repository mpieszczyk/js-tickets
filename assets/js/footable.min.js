  ...
  b.Row = b.Class.extend({
    ...
    define: function(c) {
      this.$el = b.is.element(c) || b.is.jq(c) ? a(c) : null, this.$toggle = a("<span/>", {
        "class": "footable-toggle fa fa-plus"
      });
      var d = b.is.hash(c),
      ...
      if (this.created) {
        ...
        a.ft.raise("expand.ft.row", [a]).then(function() {
          a.__hidden__ = b.arr.map(a.cells, function(a) {
            ...
            a.collapse()
          })), a.$el.attr("data-expanded", !0), a.$toggle.removeClass("fa-plus").addClass("fa-minus"), a.expanded = !0, a.ft.raise("expanded.ft.row", [a])
        })
      }
    },
    collapse: function(a) {
      if (this.created) {
        ...
        c.ft.raise("collapse.ft.row", [c]).then(function() {
          b.arr.each(c.__hidden__, function(a) {
            a.restore()
          }), c.$details.detach(), c.$el.removeAttr("data-expanded"), c.$toggle.removeClass("fa-minus").addClass("fa-plus"), (b.is["boolean"](a) ? a : !0) && (c.expanded = !1), c.ft.raise("collapsed.ft.row", [c])
        })
      }
    },
    predraw: function(a) {
...
function(a, b) {
  b.Filtering = b.Component.extend({
    ...
    setButton: function(a) {
      a ? this.$button.children(".fa").removeClass("fa-remove").addClass("fa-search") : this.$button.children(".fa").removeClass("fa-search").addClass("fa-remove")
    },
    find: function(a) {
    ...
    _onSearchButtonClicked: function(a) {
      ...
      var c = b.$button.children(".fa");
      if (c.hasClass("fa-remove")) b.clear();
      else {
        var d = b.$input.val();
    ...
    _onSearchColumnClicked: function(a) {
      ...
      null != b._filterTimeout && clearTimeout(b._filterTimeout), b._filterTimeout = setTimeout(function() {
        ...
        var a = b.$button.children(".fa");
        a.hasClass("fa-remove") && (a.removeClass("fa-remove").addClass("fa-search"), b.addFilter("search", b.$input.val()), b.filter())
      }, b.delay)
    },
  ...
  b.Sorting = b.Component.extend({
    ...
    destroy: function() {
      ...
      this.ft.raise("destroy.ft.paging").then(function() {
        a.ft.$el.off("click.footable", ".footable-sortable", a._onSortClicked), a.ft.$el.children("thead").children("tr.footable-header").children(".footable-sortable").removeClass("footable-sortable footable-asc footable-desc").find("span.fa").remove()
      })
    },
    predraw: function() {
      if (this.column) {
    ...
    draw: function() {
      if (this.column) {
        var a = this,
          ...
          c = a.column.$el;
        b.removeClass("footable-asc footable-desc").children(".fa").removeClass("fa-sort fa-sort-asc fa-sort-desc"), b.not(c).children(".fa").addClass("fa-sort"), c.addClass("DESC" == a.column.direction ? "footable-desc" : "footable-asc").children(".fa").addClass("DESC" == a.column.direction ? "fa-sort-desc" : "fa-sort-asc")
      }
    },
    sort: function(a, b) {
...
function(a, b) {
  b.Defaults.prototype.editing = {
    ...
    viewRow: function(a) {},
    showText: '<span class="fa fa-pencil" aria-hidden="true"></span> Edit rows',
    hideText: "Cancel",
    addText: "New row",
    editText: '<span class="fa fa-pencil" aria-hidden="true"></span>',
    deleteText: '<span class="fa fa-trash" aria-hidden="true"></span>',
    viewText: '<span class="fa fa-stats" aria-hidden="true"></span>',
    allowAdd: !0,
    allowEdit: !0,
    allowDelete: !0,
    allowView: !1,
